...
mini-rv32ima : mini-rv32ima.c mini-rv32ima.h default64mbdtc.h
	...
	# riscv64-unknown-elf-gcc -march=rv32i -mabi=ilp32 -static -nostdlib  -nostartfiles -mcmodel=medany -o $@ $< -g -O2 -Wall
	# riscv64-unknown-elf-gcc -march=rv32i -mabi=ilp32 -static -nostdlib  -nostartfiles -mcmodel=medany -o $@.tiny $< $(CFLAGS_TINY) 

mini-rv32ima-intel : mini-rv32ima.c mini-rv32ima.h default64mbdtc.h
	# for debug
...
clean :
	rm -rf mini-rv32ima mini-rv32ima.flt mini-rv32ima-intel
